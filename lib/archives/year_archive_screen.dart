...
class _YearRecapScreenState extends State<YearRecapScreen> {
  ...
  List<Transaction> get _allTransactions {
    return widget.months.expand((m) => m.transactions).toList();
  }
  ...
  // ─────────────────────────
  // 🌞 SUN DONUT — COPIE STRICTE DE MonthRecap
  Widget _sunDonut() {
  ...
  // ─────────────────────────
  // ACCORDÉON — IDENTIQUE MonthRecap
  ...
  String _categoryName(String? id) =>
      id == null
          ? 'Sans catégorie'
          : CategoriesStore.getById(id)?.name ??
              'Catégorie supprimée';
